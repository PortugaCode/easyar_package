...
namespace easyar
{
    ...
    public class EasyARSettings : ScriptableObject
    {
        ...
        /// <summary>
        /// <para xml:lang="en">Global Mega localization service config (used in EasyAR Mega).</para>
        /// <para xml:lang="zh">全局云定位服务器配置（EasyAR Mega功能使用）。</para>
        /// </summary>
        [Tooltip("Global Mega localization service config (used in EasyAR Mega).")]
        ...
        /// <summary>
        /// <para xml:lang="en">Disable ARCore and AREngine. This option is generally used in Unity 2019 when you do not want to deal with build fail caused by Gradle version if both ARCore and AREngine are not used. Disable ARCore and AREngine will make EasyAR ARCore and AREngine wrapper fail to run, and will make EasyAR World Sensing features like Sparse Spatial Map and Dense Spatial Map fail to run on devices where EasyAR Motion Tracking is not available but ARCore or AREngine is available. See https://developers.google.com/ar/develop/unity/android-11-build#unity_20193_and_20194 to make ARCore or AREngine work in Unity 2019.4.</para>
        /// <para xml:lang="zh">禁用ARCore和AREngine。这个选项通常在Unity 2019中使用，如果你不使用ARCore和AREngine功能且不希望处理由Gradle版本引起的编译失败的时候可以打开这个选项。禁用ARCore和AREngine将会使EasyAR的ARCore和AREngine封装无法运行，且会使EasyAR的一些世界感知功能，比如稀疏空间地图和稠密空间地图在一些支持ARCore或AREngine但不支持EasyAR运动跟踪功能的设备上无法运行。可以参考 https://developers.google.cn/ar/develop/unity/android-11-build#unity_20193_and_20194 在Unity 2019.4上使用ARCore或AREngine。</para>
        /// </summary>
        [Tooltip("Disable ARCore and AREngine. This option is generally used in Unity 2019 when you do not want to deal with build fail caused by Gradle version if both ARCore and AREngine are not used. Disable ARCore and AREngine will make EasyAR ARCore and AREngine wrapper fail to run, and will make EasyAR World Sensing features like Sparse Spatial Map and Dense Spatial Map fail to run on devices where EasyAR Motion Tracking is not available but ARCore or AREngine is available. See https://developers.google.com/ar/develop/unity/android-11-build#unity_20193_and_20194 to make ARCore or AREngine work in Unity 2019.4.")]
        ...
        public class Permission
        {
            ...
            /// <summary>
            /// <para xml:lang="en">Permission suggested for <see cref="easyar.MegaTrackerFrameFilter"/>.</para>
            /// <para xml:lang="en">Turn on this option will use (fine) Location permission on device (ONLY when com.easyar.mega package exist).</para>
            /// <para xml:lang="zh">使用<see cref="easyar.MegaTrackerFrameFilter"/>建议开启的权限。</para>
            /// <para xml:lang="zh">开启这个选项将会使用设备的（fine）定位权限（只有当com.easyar.mega package存在时才起作用）。</para>
            /// </summary>
            [Tooltip("Permission required for easyar.MegaTrackerFrameFilter. Turn on this option will use (fine) Location permission on device (ONLY when com.easyar.mega package exist).")]
        ...
        public class Workaround
        {
            ...
            public bool URP17RG_IOS_Glitches_Partial = false;
        }
    }
}
