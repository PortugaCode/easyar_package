        ...
        private class UserRequest : IDisposable
        {
            ...
            public bool UpdateTexture(Camera cam, Material material, bool invertCulling, out RenderTexture tex)
            {
                ...
                else
                {
                    ...
                    //Camera image rendering has glitches on IOS and MacOS devices.
                    //This is probably caused by Rendergraph enforced by URP17 on Unity6 since the result is fine with compatibility mode.
                    //'RenderTexture.enableRandomWrite' will make the purple glitches disappear but does not fix the translucent rectangle.
                    //The issue has been reported to unity https://discussions.unity.com/t/glitches-on-ios-with-ar-camera-image-rendering-urp-17-render-graph/1548048
                    bool workaround = !EasyARSettings.Instance || EasyARSettings.Instance.WorkaroundForUnity.URP17RG_IOS_Glitches_Partial;
                    if (workaround)
                    {
